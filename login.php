...
<body class="index-page">
    ...
    <div class="header-container container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="index.php" style="color: #f97316; font-weight: bold;">Accéder aux Tests</a></li>
        </ul>
          ...
          <div class="col-lg-5">
            ...
            <div class="contact-form card" data-aos="fade-up" data-aos-delay="200">
              <div class="card-body p-4 p-lg-5">
                ...
                <form id="loginForm" action="controllers/utilisateurcontroller.php" method="POST" novalidate>
                  ...
                  <div class="row gy-4">
                    ...
                    <div class="col-12 d-flex flex-column gap-2">
                      ...
                      <a href="controllers/oauthcontroller.php?provider=google"
                         class="btn btn-outline-danger w-100">
                        <i class="bi bi-google me-2"></i> Continuer avec Google
                      </a>

                      <a href="controllers/oauthcontroller.php?provider=github"
                         class="btn btn-outline-dark w-100">
                        <i class="bi bi-github me-2"></i> Continuer avec GitHub
                      </a>

                      <a href="controllers/oauthcontroller.php?provider=discord"
                    ...
                    <div class="col-12 text-center mt-3 pt-3 border-top">
                      <p class="text-muted small mb-2">Ou explorez nos certifications sans compte</p>
                      <a href="index.php" class="btn btn-outline-warning w-100">
                        <i class="bi bi-journal-check me-2"></i> Mode Invité : Passer un Test
                      </a>
                    </div>
  ...
  document.getElementById('btnVerifyFace').addEventListener('click', async function () {
    ...
    const res  = await fetch('controllers/get_photo.php', { method: 'POST', body: formData });
    ...
    if (distance < 0.5) {
      ...
      const loginRes  = await fetch('controllers/face_login.php', { method: 'POST', body: loginData });
