...
$prop = $ctrl->getProposition($pid);
if (!$prop) {
    $_SESSION['error'] = "Proposition introuvable.";
    header('Location: mes_propositions.php');
    exit;
}
if ((int)$prop['user_id'] !== $userId) {
    $_SESSION['error'] = "Action non autorisée.";
    header('Location: mes_propositions.php');
    exit;
}

// Parent demande summary (readonly)
$demande = $ctrl->getDemande((int)$prop['demande_id']);
if (!$demande) {
    $_SESSION['error'] = "Demande parente introuvable.";
    header('Location: mes_propositions.php');
    exit;
}
...
$errors = [];
$old = [
    'freelancer_name' => html_entity_decode($prop['freelancer_name'], ENT_QUOTES, 'UTF-8'),
    'price'           => $prop['price'],
    'message'         => html_entity_decode($prop['message'], ENT_QUOTES, 'UTF-8'),
];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $res = $ctrl->updateProposition($pid, $userId, $freelancer_name, $message, $price);
    if ($res['success']) {
        header('Location: mes_propositions.php?updated=1');
        exit;
    }
    $errors = $res['errors'];
}
...
<head>
  ...
  <title>Modifier ma proposition — SkillBridge</title>
    ...
    <section class="page-bg">
      ...
      <div class="container">
        ...
        <div class="text-center mb-5" data-aos="fade-up" style="max-width:720px;margin:0 auto;">
          <span class="eyebrow honey"><span class="dot"></span> Modifier la proposition</span>
          <h1 class="display-x mt-3 mb-2">Affinez votre <span class="accent">offre</span>.</h1>
          <p class="lead-x mb-0">Mettez à jour votre tarif et votre message pour mieux convaincre.</p>
        </div>

        <div class="row g-4 justify-content-center">

          <!-- Demande summary (readonly) -->
          <div class="col-lg-5" data-aos="fade-right">
            <div class="summary-card mb-3">
              <div class="d-flex justify-content-between align-items-center">
                <span class="eyebrow"><span class="dot"></span> Demande ciblée</span>
                <span class="readonly-badge"><i class="bi bi-lock"></i> Lecture seule</span>
              </div>
            ...
            <div class="auth-card">
              ...
              <form method="POST" id="propForm" novalidate>
                ...
                <div class="mb-4">
                  ...
                  <textarea name="message" id="message" class="form-control" rows="5" required minlength="15" placeholder="Présentez votre approche, votre expérience..."><?= htmlspecialchars($old['message']) ?></textarea>
