...
<<<<<<< HEAD
    ...
    /* HERO */
    .ef-hero { background: var(--dark); padding: 90px 0 80px; position: relative; overflow: hidden; }
    .ef-hero::before { content: ''; position: absolute; top: -100px; right: -100px; width: 400px; height: 400px; border-radius: 50%; background: radial-gradient(circle, rgba(249,115,22,0.2), transparent 70%); }
    .ef-hero::after  { content: ''; position: absolute; bottom: -80px; left: -80px; width: 300px; height: 300px; border-radius: 50%; background: radial-gradient(circle, rgba(249,115,22,0.1), transparent 70%); }
    .ef-hero-badge { display: inline-block; background: rgba(249,115,22,0.15); color: var(--accent); font-size: 0.68rem; font-weight: 700; letter-spacing: 2px; text-transform: uppercase; padding: 6px 18px; border-radius: 99px; border: 1px solid rgba(249,115,22,0.4); margin-bottom: 20px; }
    .ef-hero h1 { font-family: 'Questrial', sans-serif; font-size: 2.9rem; color: white; line-height: 1.2; }
    .ef-hero h1 span { color: var(--accent); }
    .ef-hero p { color: rgba(255,255,255,0.65); font-size: 1rem; line-height: 1.8; max-width: 480px; }
    ...
    /* STATS CARD */
    .cert-card { background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1); border-radius: 20px; padding: 28px; }
    .cert-card h3 { color: white; font-family: 'Questrial', sans-serif; font-size: 1rem; margin-bottom: 20px; }
    .cert-stats { display: flex; justify-content: space-around; border-top: 1px solid rgba(255,255,255,0.08); padding-top: 18px; }
    .cert-stats .val { color: var(--accent); font-size: 1.5rem; font-weight: 700; display: block; }
    .cert-stats .lbl { color: rgba(255,255,255,0.4); font-size: 0.62rem; text-transform: uppercase; letter-spacing: 1px; }
