...
<head>
  ...
  <title>SkillBridge — Modifier un test</title>
  ...
  <style>
    ...
    .sb-card-header h6 { font-weight: 800; color: #f6c23e; font-size: 0.85rem; text-transform: uppercase; letter-spacing: 1px; margin: 0; }
    ...
    .form-input { width: 100%; padding: 10px 14px; border: 1px solid #d1d3e2; border-radius: 6px; font-family: 'Nunito', sans-serif; font-size: 0.88rem; outline: none; color: #5a5c69; transition: border-color 0.2s; }
    ...
    .btn-save { background: #f6c23e; color: #5a5c69; padding: 10px 28px; border-radius: 6px; border: none; font-weight: 700; font-size: 0.88rem; cursor: pointer; font-family: 'Nunito', sans-serif; }
...
<body>
  ...
  <div class="sb-body">
    ...
    <div class="sb-content">
      <h4 style="font-weight:800;color:#5a5c69;margin-bottom:4px;">Modifier le test</h4>
      <p style="font-size:0.82rem;color:#858796;margin-bottom:20px;">
        <a href="index.php?action=index" style="color:#4e73df;text-decoration:none;">Tests</a> › Modifier
      </p>

      <div class="sb-card">
        <div class="sb-card-header"><h6>✏️ Modifier le test</h6></div>
        <div class="sb-card-body">

          <form action="index.php?action=update" method="POST" onsubmit="return validerFormTest()">

            <!-- ID caché pour savoir quel test modifier -->
            ...
            <div class="row g-4">
              ...
              <div class="col-md-6">
                ...
                <input type="text" id="title" name="title" class="form-input"
                       value="<?= htmlspecialchars($test_data['title']) ?>">
              ...
              <div class="col-md-6">
                ...
                <select id="category_id" name="category_id" class="form-input">
                  ...
                  <?php while ($cat = $categories->fetch(PDO::FETCH_ASSOC)): ?>
                    <option value="<?= $cat['id'] ?>"
                      <?= ($cat['id'] == $test_data['category_id']) ? 'selected' : '' ?>>
              ...
              <div class="col-md-4">
                ...
                <select id="level" name="level" class="form-input">
                  ...
                  <option value="Débutant" <?= ($test_data['level'] == 'Débutant') ? 'selected' : '' ?>>Débutant</option>
                  <option value="Moyen"    <?= ($test_data['level'] == 'Moyen')    ? 'selected' : '' ?>>Moyen</option>
                  <option value="Avancé"   <?= ($test_data['level'] == 'Avancé')   ? 'selected' : '' ?>>Avancé</option>
                </select>
              ...
              <div class="col-md-4">
                ...
                <input type="text" id="average_score" name="average_score" class="form-input"
                       value="<?= $test_data['average_score'] ?>">
