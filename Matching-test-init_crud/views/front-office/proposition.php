  ...
  <div class="page-header">
    <div class="container d-flex justify-content-between align-items-center flex-wrap gap-3">
      ...
      <div class="d-flex flex-wrap gap-2">
        <a href="addprop.html?demande_id=<?= $demande_id ?>" class="btn-outline-sb">
          <i class="bi bi-plus-circle"></i>
          Ajouter une proposition
        </a>
        <a href="mes-demandes.php" class="btn-back">
      ...
      <?php foreach ($propositions as $p): ?>
        <div class="proposition-card">
          ...
          <div class="proposition-actions">
            <a href="edit-proposition.php?id=<?= (int) $p['id'] ?>" class="btn-edit-sb">
