...
switch ($action) {
    ...
    case 'register':
        ...
        if ($utilisateur->create()) {
            ...
            $verifyLink = '../controller/verify_email.php?token=' . $token;
    ...
    case 'login':
        ...
        if ($user && password_verify($password, $user['password'])) {
            ...
            if ($user['role'] === 'admin') {
                header('Location: ../views/backoffice/users_list.php');
            } else {
                header('Location: ../views/frontoffice/EasyFolio/profil.php');
            }
