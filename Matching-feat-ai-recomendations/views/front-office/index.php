  ...
  <main class="main">
    ...
    <section id="propositions" class="portfolio section">
      ...
      <div class="container section-title" data-aos="fade-up">
        ...
        <p>Decouvrez des exemples de missions et laissez l'IA locale rapprocher les bons profils des bons besoins.</p>
      </div>
            ...
            <div class="col-lg-6 col-md-6 portfolio-item isotope-item filter-web">
              <div class="portfolio-card">
                ...
                <div class="portfolio-content">
                  <span class="category">Mission exemple</span>
    ...
    <section id="services" class="services section">
      ...
      <div class="container section-title" data-aos="fade-up">
        ...
        <p>SkillBridge analyse les demandes, les propositions et les profils avec Ollama, sans grille statique.</p>
      </div>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row align-items-center">
          <div class="col-lg-4 mb-5 mb-lg-0">
            <h2 class="fw-bold mb-4 servies-title">Des rapprochements adaptes a chaque projet</h2>
            <p class="mb-4">Les descriptions, budgets, delais et profils sont interpretes par l'IA locale pour produire des conseils et recommandations contextualises.</p>
            <?php if (!is_freelancer()): ?>
            ...
            <div class="row g-4">
              ...
              <div class="col-md-6" data-aos="fade-up" data-aos-delay="200">
                <div class="service-item">
                  ...
                  <h3><a href="<?= front_url('Addrequest.php') ?>">Analyse des demandes</a></h3>
                  <p>Conseils de budget, delai et brief produits par Qwen3 via Ollama a partir du besoin client.</p>
                </div>
              </div>
              ...
              <div class="col-md-6" data-aos="fade-up" data-aos-delay="300">
                <div class="service-item">
                  ...
                  <h3><a href="<?= front_url('mes-demandes.php') ?>">Recommandations freelancers</a></h3>
                  <p>Classement intelligent des demandes disponibles selon le profil et l'experience du freelancer.</p>
                </div>
              </div>
              ...
              <div class="col-md-6" data-aos="fade-up" data-aos-delay="400">
                <div class="service-item">
                  ...
                  <h3><a href="<?= front_url('addprop-form.php') ?>">Generation de propositions</a></h3>
                  <p>Brouillons de reponse professionnels generes localement a partir de la demande selectionnee.</p>
                </div>
              </div>
              ...
              <div class="col-md-6" data-aos="fade-up" data-aos-delay="500">
                <div class="service-item">
                  ...
                  <h3><a href="<?= front_url('mes-demandes.php') ?>">Evaluation du matching</a></h3>
                  <p>Synthese IA des forces, risques et prochaines actions pour comparer les propositions recues.</p>
                </div>
              </div>
